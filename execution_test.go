...
func TestExecutionListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Executions.List(context.TODO(), riza.ExecutionListParams{
		Limit:                riza.F(int64(0)),
		OnlyNonZeroExitCodes: riza.F(true),
...
func TestExecutionGet(t *testing.T) {
	...
	_, err := client.Executions.Get(context.TODO(), "id")
	if err != nil {
		var apierr *riza.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
